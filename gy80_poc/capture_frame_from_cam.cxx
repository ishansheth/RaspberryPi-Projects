...
using openCV APIs. If this program should be run on the raspberrypi, then it has to be cross compiled. This same program works well with openCV 3.4.2 on latest ubuntu machine with 18.04 and on raspberyy pi with openCV 2.4.13
**/
...
/** if you have not installed openCV with GTK, then leave the below code commented. Video can not be show but only can be writte in the file. On the raspberry Pi, there will probably not any of the GTK
**/
